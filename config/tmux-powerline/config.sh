...
export TMUX_POWERLINE_STATUS_LEFT_LENGTH="140"
...
# sqlite3 -list "/var/folders/tj/2pt3qvjj1bn65n_txphvgv600000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
